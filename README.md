...
Start-order packet for scope, approval language, acceptance criteria, and public-safe private-routing boundaries:

```text
https://lolomix.github.io/contract-revenue-radar/start-order.html
```
