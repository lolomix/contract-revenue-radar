...
- Submission archive: `/home/ubuntu/revenue_5000/contract-revenue-radar-submission.zip`
...
Run these from `/home/ubuntu/revenue_5000/qdrant-contract-radar` before pushing:
...
Expected API result: `backend` should be `qdrant-local-memory`, the report should include five findings for the sample contract, and the agent brief should include fallback positions plus a contract-ops checklist.
